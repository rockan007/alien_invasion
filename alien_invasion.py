...
class AlienInvasion:    
    ...
    def __init__(self):
        ...
        # Ship() requires one argumment, an instance of AlienInvasion
        # assign the Ship instance to self.ship
        self.ship=Ship(self)
        # Create a group in AlienInvasion to store all the live bullets 
    ...
    def _ship_hit(self):
        """Respond to a ship being git buy an alien"""
    ...
    def _create_fleet(self):
        ...
        #Create the full fleet if aliens
    ...
    def _change_fleet_direction(self):
        """Drop down the entire fleet and change the fleet direction"""
        for alien in self.aliens.sprites():
    ...
    def _update_bullets(self):
        ...
        # check for any bullets that hava hit aliens
    ...
    def _fire_bullet(self): 
        """Update a new bullet and add it to the bullets group"""
    ...
    def _update_screen(self):
        ...
        # Make the most rescently drawn screen visible
        pygame.display.flip()
